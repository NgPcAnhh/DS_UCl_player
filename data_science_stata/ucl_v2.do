...
* 3. Ghi log kết quả
capture log close
capture log using output.log, replace
...
tabstat rating goals assists distance total_minutes, ///
...
pwcorr goals assists distance total_minutes, sig

**************************************************
* PHẦN 2: HỒI QUY TUYẾN TÍNH ĐƠN GIẢN
**************************************************

regress rating goals assists distance total_minutes
